...
if (TSS_TTS_coord == TRUE) {
  cat("## Standard deviation and Entropy {.tabset .tabset-fade}\n\n") # Header
  cat("### Standard deviation {.tabset .tabset-fade .tabset-dropdown}\n\n")
  cat("#### TSS\n\n")
  p13
  cat("#### TTS\n\n")
  p14
  
  cat("### Entropy {.tabset .tabset-fade .tabset-dropdown}\n\n")
  cat("#### TSS\n\n")
  p15
  cat("#### TTS\n\n")
  p16
